...
- **Standalone topic docs:** [../BALANCE_NOTES.md](../BALANCE_NOTES.md), [../FINDABLES.md](../FINDABLES.md), [../COLLECTIBLE_SYSTEM.md](../COLLECTIBLE_SYSTEM.md), [../SYMBOL_GUIDELINES.md](../SYMBOL_GUIDELINES.md), and other root-level `docs/*.md` files — full list in [DOCS_CATALOG.md](./DOCS_CATALOG.md)

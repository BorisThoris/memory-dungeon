...
> Generated by `yarn docs:dungeon-archive` from the catalogs themselves, on the commit before they were
> deleted. Nothing here is remembered or paraphrased: every row is the definition the game shipped.

...
## P1 Score every source the run can earn from

- Status: done
- System: Rewards And Economy
- Detail: Any new source or sink must be scored by the match and floor-clear rules and keep the balance simulation bands.

...
import { Eyebrow, MetaFrame, Panel, ScreenTitle, StatTile, UiButton } from '../ui';
...
const PROFILE_SECTION_RAIL_ITEMS = [
    { compactLabel: 'Overview', href: '#profile-overview', label: 'Overview' },
    { compactLabel: 'Goals', href: '#profile-goals', label: 'Goals' },
    { compactLabel: 'Signals', href: '#profile-signals', label: 'Signals' },
    { compactLabel: 'Trust', href: '#profile-trust', label: 'Trust' }
] as const;
...
const compactProfileMotivationCopy = (copy: string): string =>
    copy.replace(/^Next: (.+?) \((\d+\/\d+) from .+\)\.?$/i, 'Next: $1 ($2)');
...
const ProfileScreen = () => {
    ...
    const compactProgressionMotivationCopy = compactProfileMotivationCopy(trustShell.progressionMotivationCopy);
    ...
    return (
        <section
            aria-label="Profile"
            className={`${metaStyles.shell} ${metaStyles.shellMetaStage}`}
        ...
        >
            <MetaScreenHeader
                ...
                compact
                eyebrow="Progress"
                subtitle="Local stats, dailies, mastery goals, and run context from your save."
            ...
            <div ref={bodyScrollRef} className={`${metaStyles.body} ${styles.body}`.trim()} data-testid="profile-screen-body">
                <MetaSectionRail
                    ariaLabel="Profile sections"
                    bodyScrollRef={bodyScrollRef}
                    className={styles.sectionRail}
                    compact
                    dataTestId="profile-section-rail"
                    items={PROFILE_SECTION_RAIL_ITEMS}
                />

                <MetaFrame data-testid="profile-meta-frame-overview">
                    <Panel padding="lg" variant="default">
                        <div className={`${styles.section} ${metaStyles.sectionAnchor}`} id="profile-overview">
                            ...
                            <div className={styles.progressionBrief} data-testid="profile-progression-brief">
                                ...
                                <strong data-full-progression-copy={trustShell.progressionMotivationCopy}>
                                    {compactProgressionMotivationCopy}
                                </strong>
                                <p className={styles.progressionBriefSummary}>
                                ...
                                <p className={styles.progressionBriefDetail}>{trustShell.nextMilestoneProgressCopy}</p>
                            ...
                            <div
                                className={styles.milestoneRail}
                                data-testid="profile-milestone-rail"
                                aria-label="Profile tier milestones"
                            >
                ...
                <MetaFrame data-testid="profile-meta-frame-goals">
                    <Panel padding="lg" variant="accent">
                        <div className={`${styles.section} ${metaStyles.sectionAnchor}`} id="profile-goals">
                ...
                <MetaFrame data-testid="profile-meta-frame-signals">
                    <Panel padding="md" variant="default">
                        <div className={`${styles.section} ${metaStyles.sectionAnchor}`} id="profile-signals">
                ...
                <MetaFrame data-testid="profile-meta-frame-trust">
                    <Panel className={styles.panel} padding="md" variant="default" data-testid="profile-save-trust-panel">
                        <div className={`${styles.section} ${metaStyles.sectionAnchor}`} id="profile-trust">

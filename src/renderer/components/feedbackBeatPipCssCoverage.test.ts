...
const findVisibleToneSelectorGaps = (): VisibleToneSelectorGap[] => {
    ...
    const visibleToneContracts: Record<string, readonly string[]> = {
        ...
        'data-active-power-beat-action': ['clear', 'pin', 'recall', 'remove', 'swap'],
        'data-active-power-beat-screen-cue': ['burst', 'guard', 'pulse', 'tick'],
        'data-active-power-beat-tier': ['control', 'memory', 'route'],
        'data-active-power-beat-tone': ['control', 'recall', 'setup'],
        ...
        'data-card-primary-shot-beat-pip-shot-focus': ['cashout', 'follow-up', 'route', 'setup', 'surge'],
        'data-card-primary-shot-beat-pip-screen-cue': ['burst', 'guard', 'pulse'],
        'data-chain-armed-perk-tone': ['armed', 'payoff'],
        'data-chain-callout-beat-tone': ['cashout', 'ready', 'setup', 'surge'],
        ...
        'data-chain-meter-lane-action': ['cashout', 'combo-surge', 'follow-up', 'match-route', 'prime-route'],
        'data-chain-meter-lane-tone': ['cashout', 'followup', 'ready', 'setup', 'surge'],
        'data-chain-meter-pip-action': ['cashout', 'combo-surge', 'follow-up', 'match-route', 'prime-route'],
        'data-chain-meter-pip-tone': ['cashout', 'followup', 'ready', 'setup', 'surge'],
        'data-chain-meter-tone': ['cashout', 'ready', 'setup', 'surge'],
        'data-chain-next-route-pip-tone': ['cashout', 'ready', 'setup', 'surge'],
...
const findVisibleStateSelectorGaps = (): VisibleStateSelectorGap[] => {
    ...
    const visibleStateContracts: Record<string, readonly string[]> = {
        ...
        'data-chain-reward-beat-lane-action': ['Cash next', 'Hold streak', 'Prime cashout'],
        'data-chain-reward-beat-screen-cue': ['burst', 'pulse', 'tick'],
        'data-chain-reward-beat-tone': ['guard', 'heal', 'reward'],
        'data-chain-reward-beat-urgency': ['later', 'next', 'soon'],
        'data-chain-reward-stack-beat-screen-cue': ['burst', 'pulse', 'tick'],
        'data-chain-reward-stack-beat-tone': ['guard', 'heal', 'reward'],
        'data-chain-reward-stack-beat-urgency': ['later', 'next', 'soon'],
        ...
        'data-chapter-action-beat-screen-cue': ['burst', 'guard', 'pulse', 'snap'],
        'data-chapter-action-beat-tone': ['counter', 'objective', 'pressure', 'reward', 'safe'],
        'data-chapter-signal-beat-screen-cue': ['burst', 'guard', 'pulse', 'snap'],
        'data-chapter-signal-beat-tone': ['counter', 'objective', 'pressure', 'reward', 'safe'],
        ...
        'data-chain-streak-beat-screen-cue': ['burst', 'pulse', 'super'],
        ...
        'data-floor-payoff-stack-beat-action': ['Bank stack', 'Build bigger', 'Recover value', 'Rebuild stack'],
        'data-floor-payoff-stack-beat-screen-cue': ['burst', 'pulse', 'risk', 'super'],
        'data-floor-payoff-stack-beat-tone': ['combo', 'missed', 'reward', 'setup', 'super'],
        ...
        'data-risk-wager-primary-beat-tone': ['armed', 'offer'],
        'data-risk-wager-signal-beat-screen-cue': ['armed', 'burst', 'objective', 'risk'],
        ...
        'data-onboarding-signal-beat-screen-cue': ['action', 'burst', 'chain', 'recover', 'route'],
        'data-onboarding-signal-beat-tone': ['action', 'chain', 'recovery', 'reward', 'route'],
        ...
        'data-match-payoff-stack-beat-screen-cue': ['burst', 'chain', 'pulse', 'super'],
        'data-match-payoff-stack-beat-tone': ['chain', 'combo', 'reward', 'score'],
        'data-match-impact-cue-beat-screen-cue': ['burst', 'pulse', 'route', 'surge'],
        'data-match-impact-cue-beat-tone': ['chain', 'combo', 'pickup', 'reward', 'route', 'trait'],
        'data-match-jackpot-beat-screen-cue': ['burst', 'cashout', 'super'],
        'data-match-jackpot-beat-tier': ['cashout', 'stack', 'super'],
        'data-match-crescendo-beat-screen-cue': ['burst', 'pulse', 'snap', 'super'],
        ...
        'data-mismatch-recovery-primary-lane-beat-screen-cue': ['chain', 'recover', 'risk', 'tool'],
        'data-mismatch-recovery-chip-beat-screen-cue': ['chain', 'lost', 'recover', 'risk', 'tempo', 'tool'],
        'data-mismatch-recovery-chip-beat-tone': ['chain', 'recover', 'risk', 'tempo', 'tool'],
        'data-mismatch-recovery-chip-beat-urgency': ['one-away', 'setup'],
        ...
        'data-pickup-chip-beat-action': ['bank', 'cashout', 'stack'],
        'data-pickup-chip-beat-screen-cue': ['burst', 'pulse', 'tick'],
        'data-pickup-chip-beat-tier': ['cashout', 'multi', 'reward'],
        ...
        'data-reward-burst-beat-screen-cue': ['burst', 'pulse', 'super'],
        'data-reward-burst-beat-tier': ['mega', 'single', 'stack'],
        ...
        'data-route-action-cue-beat-screen-cue': ['build', 'burst', 'memory', 'pulse', 'risk'],
        'data-route-action-cue-beat-tone': ['build', 'memory', 'reward', 'risk', 'route'],
        ...
        'data-route-choice-signal-beat-screen-cue': ['burst', 'risk'],
        'data-route-choice-signal-beat-signal': ['reward', 'risk'],
        'data-route-impact-cue-beat-screen-cue': ['build', 'burst', 'memory', 'pulse', 'risk'],
        'data-route-impact-cue-beat-tone': ['build', 'memory', 'reward', 'risk', 'route'],
        'data-route-payoff-beat-screen-cue': ['build', 'burst', 'memory', 'pulse', 'risk'],
        ...
        'data-route-signal-beat-signal': ['reward', 'risk'],

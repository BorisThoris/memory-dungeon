...
describe('ChooseYourPathScreen REG-010 discoverability', () => {
    ...
    it('defaults a fresh profile to Classic Run with browse content open', () => {
        ...
        expect(classicLaneMap).toHaveAttribute('data-mode-primary-lane-role-id', 'build');
        ...
        expect(classicLaneMap.querySelector('[data-mode-lane="chain"]')).toHaveAttribute('data-mode-lane-role-id', 'build');
        ...
        expect(classicLaneMap.querySelector('[data-mode-lane="reward"]')).toHaveAttribute('data-mode-lane-role-id', 'reward');
        ...
        expect(classicPrimaryLane).toHaveAttribute('data-mode-primary-lane-role-id', 'build');
    ...
    it('shows browse/search/page and locked-mode copy by default', () => {
        ...
        expect(showcaseLaneMap).toHaveAttribute('data-mode-primary-lane-role-id', 'build');
        ...
        expect(showcasePrimaryLane).toHaveAttribute('data-mode-primary-lane-role-id', 'build');

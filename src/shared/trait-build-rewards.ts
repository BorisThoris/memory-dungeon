...
export const TRAIT_BUILD_REWARD_ROWS: readonly TraitBuildRewardRow[] = [
    {
        ...
        relicIds: ['chapter_compass', 'peek_charge_plus_one', 'tithe_conduit', 'echo_relay'],
    ...
    },
    {
        ...
        relicIds: ['combo_shard_plus_step', 'bulwark_plate', 'echo_relay'],
    ...
    },
    {
        ...
        relicIds: ['region_shuffle_free_first', 'first_shuffle_free_per_floor', 'drift_appraiser'],
    ...
    },
    {
        ...
        relicIds: ['guard_token_plus_one', 'memorize_bonus_ms', 'stasis_broker'],
    ...
    },
    {
        ...
        relicIds: ['guard_token_plus_one', 'combo_shard_plus_step', 'chapter_compass', 'stasis_broker', 'tithe_conduit'],
    ...
    },
    {
        ...
        relicIds: ['parasite_ledger', 'wager_surety', 'shrine_echo', 'drift_appraiser'],

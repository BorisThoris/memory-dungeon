import type { RelicId, RunShopItemId, TileTraitKind } from './contracts';
...
export const TRAIT_BUILD_REWARD_ROWS: readonly TraitBuildRewardRow[] = [
    {
        ...
        shopItemIds: ['peek_charge', 'region_shuffle_charge'],
    ...
    },
    {
        ...
        shopItemIds: ['region_shuffle_charge', 'peek_charge'],
    ...
    },
    {
        ...
        shopItemIds: ['region_shuffle_charge'],
    ...
    },
    {
        ...
        shopItemIds: ['heal_life', 'region_shuffle_charge'],
    ...
    },
    {
        ...
        shopItemIds: ['heal_life', 'region_shuffle_charge', 'iron_key'],

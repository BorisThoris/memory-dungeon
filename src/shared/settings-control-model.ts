...
export const SETTINGS_REFERENCE_CONTROL_ROWS: readonly SettingsReferenceControlRow[] = [
    {
        ...
        hint: 'Reference only: shipped balance is the Standard profile (one par curve, a run-wide miss bank topped up by one each floor, softened memorize curve).',
        options: ['Easy', 'Normal', 'Hard', 'Nightmare'],
        persistedSettingKey: null,
        ruleImpact: 'Would require GAME_RULES_VERSION because scoring, the miss bank, and fairness identity change.',
    ...
    },
    {
        ...
        hint: 'Hidden cards use one shared back; hidden-card theme variants are not available.',
        options: ['Shared Card Back'],
        persistedSettingKey: null,

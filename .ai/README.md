...
The JSON file is authoritative for tools but not the source of gameplay truth. TypeScript remains authoritative for derived structure and `src/shared/gameplay-interaction-graph-data.json` remains authoritative for curated relationships that static analysis cannot infer.

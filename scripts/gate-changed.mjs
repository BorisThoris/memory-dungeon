...
export const selectGatesForChangedPaths = (paths) => {
    ...
    for (const file of normalized) {
        ...
        if (file.startsWith('src/renderer/cardFace/') || file.startsWith('src/renderer/components/tileTextures') || file.startsWith('src/renderer/components/tileBoardReadability') || file.startsWith('src/renderer/components/tileBoardRows') || file === 'src/renderer/components/TileBezel.tsx' || file.startsWith('src/renderer/components/cardGlowFrame') || file.startsWith('src/renderer/components/tileBoardCardHeat') || file.startsWith('src/renderer/components/AnimatedCardGlow') || file.startsWith('src/renderer/components/GameplayScene') || file.startsWith('src/renderer/components/gameplayScene') || file.startsWith('src/renderer/components/CathedralScene') || file.startsWith('src/renderer/components/PortalScene') || file.startsWith('src/renderer/components/SceneSprites') || file.startsWith('src/renderer/components/scenePlate') || file.startsWith('src/renderer/hooks/useSceneLook') || file.startsWith('src/renderer/hooks/useSceneEffectTier') || file === 'scripts/card-pipeline/cut_card_back_glow.py' || file.startsWith('scripts/build-card-illustration-manifest') || file === 'scripts/card-pipeline/export-face-panel-webp.mjs' || file === 'scripts/card-pipeline/export-ui-background-webp.mjs' || file === 'scripts/card-pipeline/export-card-normal-webp.mjs' || file === 'scripts/audit-renderer-assets.mjs') {
